...
const AuthorSocialMedia = ({ className, social }) => {
  ...
  return (
    <div className={clsx(classes.root, className)}>
      {social.linkedin && (
        <Link href={social.github} passHref={false}>
          <IconButton className={classes.social} color="primary" size="small">
            <SvgIcon>
              <svg
                fill="none"
                height="24"
      ...
      {social.github && (
        <Link className={classes.social} href={social.github} passHref={true}>
          <IconButton className={classes.social} color="primary" size="small">
            <SvgIcon>
              <svg
                fill="none"
